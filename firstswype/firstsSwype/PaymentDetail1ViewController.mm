//
//  PaymentDetail1ViewController.m
//  firstsSwype
//
...
@implementation PaymentDetail1ViewController
...
- (void)viewDidLoad
{
    ...
    name.text = [standardUserDefault objectForKey:@"name"];
    creditCardNo.text = [standardUserDefault objectForKey:@"ccno"];
    [dateVallue setTitle:[standardUserDefault objectForKey:@"date"] forState:0];
